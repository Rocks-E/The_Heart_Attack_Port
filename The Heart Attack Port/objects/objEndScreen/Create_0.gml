ColorsInit();
GlobalInit();
CLICK_URL = "https://www.necessarygames.com/my-games/heart-attack?utm_source=in_game_link&utm_medium=html5_game&utm_campaign=the_heart_attack#disqus_thread";
