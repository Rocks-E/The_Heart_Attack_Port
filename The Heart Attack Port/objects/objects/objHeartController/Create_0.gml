...
beatAlarm=noone; //beatAlarm(heartRate, beat)
...
function HeartController(_personController, _x = 0, _y = 0, _hotZoneX = 100, _direction = 180, _heartRate = 120, _pulseSpeed = 2)  {
	//super(x, y)
	x = _x;
	y = _y;
...
/* using hotzone temp
	self.hotZone = instance_create_depth(0,0,0, objHotZone);
	self.hotZone.x=_hotZoneX;
	self.hotZone.y=_y;
	self.hotZone.heartController=self;
	*/
