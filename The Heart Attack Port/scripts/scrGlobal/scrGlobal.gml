...
global.HOT_ZONE_COLOR_DEFAULT = BLACK;
global.HOT_ZONE_COLOR_ACTIVE = WHITE;
global.PULSE_COLOR_DEFAULT = BLACK;
global.PULSE_COLOR_HIT = WHITE;
global.PULSE_COLOR_MISSED = BLOOD_RED;
...
global.HEART_RATE_01 = (5 * FRAME_RATE);
global.PULSE_SPEED_01 = 1;

global.HEART_RATE_02 = (3 * FRAME_RATE);
global.PULSE_SPEED_02 = 1.5;

global.HEART_RATE_03 = (2 * FRAME_RATE);
global.PULSE_SPEED_03 = 2;

global.FINAL_HEART_RATE_TWEEN_DURATION = (60 * FRAME_RATE);
global.HEART_RATE_04 = (0.2 * FRAME_RATE);
global.PULSE_SPEED_04 = 8;

// Photo display times - no longer used.
global.PHOTO_DISPLAY_TIME_01 = (3 * FRAME_RATE);
global.PHOTO_DISPLAY_TIME_02 = (3 * FRAME_RATE);
global.PHOTO_DISPLAY_TIME_03 = (3 * FRAME_RATE);	
